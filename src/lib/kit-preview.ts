...
export function getKitPreview(kit: KitDefinition) {
  ...
  return { armor, weapon: weapon ? { src: `/generated/kit-models/${kit.key}/held-item.json`, name: getItemDisplayName(weapon) } : null };
}

export function getKitWeapon(kit: KitDefinition) {
